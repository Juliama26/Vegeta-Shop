...
const main = async () => {
  ...
  const data: Prisma.ProductCreateInput[] = [
    {
      name: "Wortel",
      imageUrl: "/assets/products/wortel.jpeg",
    ...
    {
      name: "Jagung",
      imageUrl: "/assets/products/jagung.jpeg",
      category: ProductCategory.VEGETABLE,
      description:
    ...
    {
      name: "Semangka",
      imageUrl: "/assets/products/semangka.jpeg",
    ...
    {
      name: "Jahe",
      imageUrl: "/assets/products/jahe.jpeg",
    ...
    {
      name: "Kacang Tanah",
      imageUrl: "/assets/products/kacang.jpeg",
    ...
    {
      name: "Jamur Kancing",
      imageUrl: "/assets/products/jamur.png",
    ...
    {
      name: "Buah Naga",
      imageUrl: "/assets/products/buah naga.png",
      category: ProductCategory.FRUIT,
      description:
    ...
    {
      name: "Sawi",
      imageUrl: "/assets/products/sawi.jpeg",
      category: ProductCategory.FRUIT,
      description:
    ...
    {
      name: "Bayam Merah",
      imageUrl: "/assets/products/bayam.jpeg",
      category: ProductCategory.VEGETABLE,
      description:
    ...
    {
      name: "Daung Bawang",
      imageUrl: "/assets/products/daun bawang.jpeg",
      category: ProductCategory.VEGETABLE,
      description:
